        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center p-4 z-50 animate-fade-in">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto relative">
                ...
                <div className="p-6 sm:p-8 space-y-6">
                    <h3 className="text-2xl font-bold font-cinzel text-gray-900 dark:text-white">Configurações do Dojo</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                         ...
                         <div>
                          ...
                          <input id="phone" type="text" value={phone} onChange={(e) => setPhone(e.target.value)} className="bg-gray-200 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-red-500 dark:focus:ring-white focus:border-red-500 dark:focus:border-white block w-full p-2.5"/>
                        </div>
                        <div>
                          ...
                          <input id="instagram" type="text" value={instagram} onChange={(e) => setInstagram(e.target.value)} className="bg-gray-200 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-red-500 dark:focus:ring-white focus:border-red-500 dark:focus:border-white block w-full p-2.5" placeholder="@seuinstagram"/>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                            ...
                            <button
                                ...
                                className={`p-3 text-sm text-center rounded-lg border-2 transition-colors ${selectedModalities.some(m => m.name === art.name) ? 'bg-red-600 border-red-500 text-white' : 'bg-gray-200 dark:bg-gray-700 border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500'}`}
                            >
                                {art.name}
                            </button>
                            ))}
                    ...
                    <div className="flex justify-end gap-4 pt-4">
                        ...
                        <button type="button" onClick={handleSave} disabled={loading} className="px-6 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors font-semibold disabled:opacity-50 flex items-center justify-center min-w-[100px]">
